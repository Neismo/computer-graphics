...
window.onload = function init(){
    ...
    P = perspective(90, aspect, 0.3, 10);
...
function textureFunction(){
    ...
    image2.textarget = gl.TEXTURE_2D;
    image2.onload = function(event){
        var image2 = event.target;
        gl.activeTexture(gl.TEXTURE1);
        gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true);
        gl.texImage2D(image2.textarget, 0, gl.RGB, gl.RGB, gl.UNSIGNED_BYTE, image2);
    }
    image2.src = 'textures/normalmap.png';*/

    gl.activeTexture(gl.TEXTURE1);
    var image2 = document.getElementById("texImage");
    ...
    gl.uniform1i(gl.getUniformLocation(program, "tex2D"), 1);
